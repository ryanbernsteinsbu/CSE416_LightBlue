...
function Home() {
    ...
    if ($[0] !== "3d287632977c257a230f00edae213077137729032d83ef324b1ce19b34f32e0e") {
        for(let $i = 0; $i < 28; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "3d287632977c257a230f00edae213077137729032d83ef324b1ce19b34f32e0e";
    }
        ...
        t1 = ({
            "Home[fetchLeagues]": async ()=>{
                ...
                try {
                    ...
                    const { data } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$catch23$2d$next$2f$src$2f$lib$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getUserLeagues"])(user_id);
...
//# sourceMappingURL=catch23-next_src_0-ss7r2._.js.map