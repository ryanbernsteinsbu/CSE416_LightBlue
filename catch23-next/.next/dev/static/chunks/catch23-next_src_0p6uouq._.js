...
function LeagueDraftBoard({ league, onBack }) {
        ...
        "LeagueDraftBoard.useEffect": ()=>{
            const fetchTeams = {
                "LeagueDraftBoard.useEffect.fetchTeams": async ()=>{
                    try {
                        const { data } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$catch23$2d$next$2f$src$2f$lib$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getLeagueTeams"])(league.id);
                        const loaded = await Promise.all(data.map({
                            "LeagueDraftBoard.useEffect.fetchTeams": async (t_0)=>{
                                ...
                                const { data: picks } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$catch23$2d$next$2f$src$2f$lib$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getTeamDraftPicks"])(t_0.id);
                                picks.forEach({
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$catch23$2d$next$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "LeagueDraftBoard.useEffect": ()=>{
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$catch23$2d$next$2f$src$2f$lib$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getAllPlayers"])().then({
    ...
    const handleSaveDraft = async ()=>{
        ...
        try {
            ...
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$catch23$2d$next$2f$src$2f$lib$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["saveDraftPicks"])({
                picks: picks_0,
    ...
    const addTeam = async ()=>{
        ...
        try {
            const { data: data_1 } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$catch23$2d$next$2f$src$2f$lib$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createTeam"])(newTeam.name, league.id);
    ...
    const removeTeam = async (teamId)=>{
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$catch23$2d$next$2f$src$2f$lib$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["deleteTeam"])(teamId);
...
function Home() {
    ...
    if ($[0] !== "25701dca04f0a033d9df2603f03342c9285c87a025cad3fa3a2465ed582f0790") {
        for(let $i = 0; $i < 28; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "25701dca04f0a033d9df2603f03342c9285c87a025cad3fa3a2465ed582f0790";
    }
    let t0;
    if ($[1] === Symbol.for("react.memo_cache_sentinel")) {
        t0 = [];
        ...
        t1 = ({
            "Home[fetchLeagues]": async ()=>{
                ...
                try {
                    ...
                    const { data } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$catch23$2d$next$2f$src$2f$lib$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getUserLeagues"])(userId);
...
_s(Home, "/a4V+378v3+CgUFvpcShW1zWzPo=");
_c = Home;
async function _HomeFetchLeaguesDataMap(league) {
    const { data: teams } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$catch23$2d$next$2f$src$2f$lib$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getLeagueTeams"])(league.id);
    return {
        ...league,
...
function Login({ onLoginSuccess, handleError, onShowRegister }) {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$catch23$2d$next$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        id: "login_setup",
        children: [
            errorBanner && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$catch23$2d$next$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$catch23$2d$next$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("form", {
                id: "login_form",
...
_s(Login, "Qya1RMWAdH7Wx43Scb4jTSwEH08=");
_c = Login;
var _c;
...
function Register(t0) {
    ...
    if ($[0] !== "a8967a59c0cd26aca7cddad258edf1d114ff75e43b0060a2b3edf8292496f204") {
        for(let $i = 0; $i < 47; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "a8967a59c0cd26aca7cddad258edf1d114ff75e43b0060a2b3edf8292496f204";
    }
...
function AuthScreen(t0) {
    ...
    if ($[0] !== "f390c8dad4e64fd34a2bb36505e65398cb29ba368318b90ef7b427e49d096e2c") {
        for(let $i = 0; $i < 7; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "f390c8dad4e64fd34a2bb36505e65398cb29ba368318b90ef7b427e49d096e2c";
    }
...
var __TURBOPACK__imported__module__$5b$project$5d2f$catch23$2d$next$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$compiler$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/catch23-next/node_modules/next/dist/compiled/react/compiler-runtime.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$catch23$2d$next$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/catch23-next/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$catch23$2d$next$2f$node_modules$2f$jwt$2d$decode$2f$build$2f$esm$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/catch23-next/node_modules/jwt-decode/build/esm/index.js [app-client] (ecmascript)");
...
function Page() {
    _s();
    const $ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$catch23$2d$next$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$compiler$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["c"])(7);
    if ($[0] !== "887478241a69e7f43d590884b6648fba82d32fef731760a42381cb009850f4cf") {
        for(let $i = 0; $i < 7; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "887478241a69e7f43d590884b6648fba82d32fef731760a42381cb009850f4cf";
    }
    ...
    if ($[4] !== authView || $[5] !== isLoggedIn) {
        t3 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$catch23$2d$next$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$catch23$2d$next$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
            children: [
                t2,
                isLoggedIn ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$catch23$2d$next$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "catch23",
                    ...
                    onLoginSuccess: {
                        "Page[<AuthScreen>.onLoginSuccess]": (data)=>{
                            ...
                            ;
                            try {
                                const decoded = (0, __TURBOPACK__imported__module__$5b$project$5d2f$catch23$2d$next$2f$node_modules$2f$jwt$2d$decode$2f$build$2f$esm$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jwtDecode"])(token_0);
...
//# sourceMappingURL=catch23-next_src_0p6uouq._.js.map