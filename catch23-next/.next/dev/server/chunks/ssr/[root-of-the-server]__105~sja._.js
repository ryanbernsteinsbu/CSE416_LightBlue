...
function Home() {
    ...
    const [activeLeague, setActiveLeague] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$catch23$2d$next$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    const fetchLeagues = async ()=>{
        try {
            ...
            const { data } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$catch23$2d$next$2f$src$2f$lib$2f$api$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getUserLeagues"])(userId);
...
function Login({ onLoginSuccess, handleError, onShowRegister }) {
    ...
    const handleLogin = async (e)=>{
        ...
        try {
            ...
            if (backendMsg === "User not found" || backendMsg === "Invalid password") {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__105~sja._.js.map